...
export default function DocumentTemplate({ documentData }) {
  ...
  return <div className="sveDocPage">
    ...
    <div className="sveDocFooter">Sistema de Validación Electrónica (SVE) · SVE.InformesPsicologicos.com</div>
  </div>;
}
